...
export default function Checkout() {
  ...
  return (
    <div className=" overflow-hidden">
      <Card className="w-full pt-6 bg-white   ">
        <CardHeader
          color="gray"
          floated={false}
          shadow={false}
          className="m-0 grid place-items-center px-4 py-6 text-center">
          <div className="mb-0 h-20 p-6 text-white">
            {type === "card" ? (
              <CreditCardIcon className="h-5 w-10 text-white bg-blue-800" />
            ) : (
              <img
                alt="paypal "
                className="w-14 "
                ...
                <form className="mt-2  flex flex-col gap-4">
                  ...
                  <div className="my-3">
                    ...
                    <Input
                      ...
                      icon={
                        <CreditCardIcon className="absolute left-0 h-10 w-4 text-blue-gray-300" />
                      }
                  ...
                  <Typography
                    ...
                    <LockClosedIcon className="-mt-0.5 h-20  w-4" /> Payments
